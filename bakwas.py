...
def excluded_current_year_day(current_year,current_month,current_day,birth_year):

     ##2 2 1996
     #i=current_day+1
     i=current_day
     a=is_leap(current_year)
     print ("Value of a is:", a)
     if a==True and current_year!=birth_year:
        ...
        while i <= MONTHS_OF_LEAPYEAR[current_month-1]:
            ...
            days = days - 1
            i=i+1
     elif a==False and current_year!=birth_year:
        days = 365
        ...
        days = 0
        print ("I am in excluded_current_year_day else")
        while i <= MONTHS_OF_LEAPYEAR[current_month-1]:
...
inputs=(2018,2,16,2018,2,17) #(year month day)
birth_year=inputs[0]
...
if birth_year > current_year:
    ...
    print (year_days)
    excluded_current_day=excluded_current_year_day(current_year,current_month,current_day, birth_year)
